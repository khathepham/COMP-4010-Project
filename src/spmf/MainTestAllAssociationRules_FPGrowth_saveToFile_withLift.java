...
public class MainTestAllAssociationRules_FPGrowth_saveToFile_withLift {
	...
	public static void main(String[] arg) throws IOException {
		...
		String output = ".//outputFPG_withLift.txt";
		...
		double minsupp = Double.parseDouble(arg[0]);//0.5
		...
		// Agrawal & Srikant, 94)
		double minlift = Double.parseDouble(arg[1]);// 0.1;
		double minconf = Double.parseDouble(arg[2]);// 0.50;
