 ...
 */
public class DoNotRunThis_MainTestAllAssociationRules_CFPGrowth_saveToFile {

	public static void main(String[] arg) throws IOException {
		String input = fileToPath("pokeparse.txt");
		String output = ".//outputCFPG.txt";
		String MISfile = fileToPath("MIS_CFPG.txt");
		...
		// Agrawal & Srikant, 94)
		double minconf = Double.parseDouble(arg[0]); // 0.50;
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = DoNotRunThis_MainTestAllAssociationRules_CFPGrowth_saveToFile.class.getResource(filename);
