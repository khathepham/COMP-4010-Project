 ...
 */
public class DoNotRunThis_MainTestAllAssociationRules_CFPGrowth_saveToFile_withLift {

	public static void main(String[] arg) throws IOException {
		String input = fileToPath("pokeparse.txt");
		String output = ".//outputCFPG_withLift.txt";
		String MISfile = fileToPath("MIS_CFPG_withLift.txt");
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = DoNotRunThis_MainTestAllAssociationRules_CFPGrowth_saveToFile_withLift.class.getResource(filename);
